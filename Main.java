    ...
    public static void main(String [] args) throws SQLException {
            ...
            while(true) {
                ...
                if (request.toLowerCase(Locale.ROOT).equals("post")) {
                    ...
                    dataBaseControl.insertUser(inSurname, inName, inClassNumber, inClassLiter, 0, description);
                ...
                } else if (request.toLowerCase(Locale.ROOT).equals("count")) {
                    System.out.println(dataBaseControl.countUsers());
                } else {
