...
public class DataBaseControl {
    ...
    public void insertUser(String surname, String name, String classNumber, String classLiter, int points, String description) {
        postQuery(surname, name, classNumber, classLiter, points, description);
    }
    ...
    private void postQuery(String surname, String name, String classNumber, String classLiter, int points, String description) {
        try {
            String postQuery = "INSERT INTO users_db (surname, name, class, liter, points, description) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        try {
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    User userCycle = new User(surname, name, classNumber, classLiter, points, description);
                    users.add(userCycle);
                }
            }
    ...
    protected int countUsers() throws SQLException {
        String sql = "SELECT COUNT(*) FROM users_db";
